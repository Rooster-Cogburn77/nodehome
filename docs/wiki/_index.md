...
| [inference-architectures](research/inference-architectures.md) | Watch lane | Orthrus and future decoding/serving architectures that could affect local inference speed |
