...
1. **Hallucination eval baseline.** Run the eval harness against the live homelab model lanes and manually score the corpus before claiming the controls improved real output quality. Re-run the corpus after any model/profile swap.
