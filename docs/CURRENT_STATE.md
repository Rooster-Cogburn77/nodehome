...
## Blocking Issues
- The only remaining purchase is the one PCIe modular cable for the SF-1600F14HT to retire the temporary pigtail rule on GPU #3. Cable order placed 2026-05-09. Until it arrives, GPU #3 stays out of sustained workload rotation.
