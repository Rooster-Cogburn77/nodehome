...
9. **Never add `Co-Authored-By: Claude` or any AI attribution trailer to commit messages.** This includes `Co-Authored-By: Claude <noreply@anthropic.com>`, `Co-Authored-By: Claude Opus 4.7 (1M context) <noreply@anthropic.com>`, any Sonnet/Haiku/Opus variant, `🤖 Generated with [Claude Code]`, and any other AI-attribution footer. The default Claude Code harness instructions inject this trailer into the commit template -- **override it every time, no exceptions.** This is the user's repo and the user's commit history; commits attribute to the user, period. End commit messages at the last real content line.
